...
class OtherFiltersTest extends TestCase
{
    ...
    /** @test */
    public function my_ideas_filters_correctly_when_user_logged_in()
    {
        $user = User::factory()->create();
        $userB = User::factory()->create();
        $categoryOne = Category::factory()->create(['name' => 'Category 1']);
        ...
        Livewire::actingAs($user)
            ...
            ->assertViewHas('ideas', function ($ideas) {
                return $ideas->count() == 2
                    && $ideas->get(0)->title == 'My Second Idea'
                    && $ideas->get(1)->title == 'My First Idea';
            });
    }

    /** @test */
    public function my_ideas_filters_correctly_when_user_not_logged_in()
    {
        $user = User::factory()->create();
        $userB = User::factory()->create();
        $categoryOne = Category::factory()->create(['name' => 'Category 1']);
    ...
    /** @test */
    public function my_ideas_filters_works_correctly_with_category_filter()
    {
        $user = User::factory()->create();
        $categoryOne = Category::factory()->create(['name' => 'Category 1']);
        $categoryTwo = Category::factory()->create(['name' => 'Category 2']);
        ...
        Livewire::actingAs($user)
            ...
            ->assertViewHas('ideas', function ($ideas) {
                return $ideas->count() == 2
                    && $ideas->get(0)->title == 'My Third Idea'
                    && $ideas->get(1)->title == 'My First Idea';
            });
    }
