  ...
  <div class="buttons-container flex items-center justify-between mt-6">
    <div class="flex items-center space-x-4 ml-6">
      <div class="relative" x-data="{isOpen: false}">
        ...
        <div x-cloak x-show="isOpen" x-transition.origi.top.left @click.away="isOpen = false"
          ...
          <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex items-center space-x-2" x-data="{isOpen: false}">
              <button @click="isOpen = !isOpen"
                ...
                <ul x-cloak x-show="isOpen" x-transition.origin.top.left @click.away="isOpen = false"
                  @keydown.escape.window="isOpen = false"
                  class="absolute w-44 z-10 font-semibold bg-white shadow-dialog rounded-xl py-3 text-left ml-8">
                  <li>
                    <a href="#" class="block hover:bg-gray-100 px-5 py-3 transition duration-150 ease-in">
                      Mark as Spam
                    </a>
